...
import comp3170.demos.week10.sceneobjects.Cylinder;
import comp3170.demos.week10.sceneobjects.Light;
import comp3170.demos.week10.sceneobjects.Plane;

public class ToonShading extends JFrame implements GLEventListener {

	private GLCanvas canvas;

	final private float TAU = (float) (Math.PI * 2);
	
	final private File DIRECTORY = new File("src/comp3170/demos/week10");
	...
	final private String TOON_VERTEX_SHADER = "toonVertex.glsl";
	final private String TOON_FRAGMENT_SHADER = "toonFragment.glsl";
	...
	public ToonShading() {
		super("COMP3170 Week 10 Toon Shading");
	...
	public void init(GLAutoDrawable drawable) {
		...
		// Compile the shader
		try {
			File vertexShader = new File(DIRECTORY, SIMPLE_VERTEX_SHADER);
			File fragmentShader = new File(DIRECTORY, SIMPLE_FRAGMENT_SHADER);
			...
			vertexShader = new File(DIRECTORY, TOON_VERTEX_SHADER);
			fragmentShader = new File(DIRECTORY, TOON_FRAGMENT_SHADER);
			this.toonShader = new Shader(vertexShader, fragmentShader);
		...
		cylinder = new Cylinder(toonShader);
		cylinder.setParent(this.root);
		cylinder.localMatrix.scale(1,2,1);
	...
	public void update(float dt) {
		...
		this.cylinder.setViewDir(viewDir);
		...
		this.cylinder.setLightDir(this.lightDir);
